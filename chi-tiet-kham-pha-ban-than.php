<?php
/*
Template Name: Chi tiết Khám phá bản thân
*/
?>
<?php get_header(); ?>
<main id="main">
    ...
    <div id="zek_service_detail_page">
        ...
        if($chas) { ?>
        <?php foreach ($chas as $cha) {$sub = $cha['sub'];$title = $cha['title']; ?>
        <div class="zek_service_detail_banner">
            <div class="container-fluid">
                <div class="banner zek_background" style="background-image: url(<?php echo  $cha['bg'] ?>);">
                    <div class="zek_block">
                        <div class="container">
                            <div class="flex">
                                <div class="img">
                                ...
                                <div class="inner">
                                    <div class="bread"><?php echo  $cha['breadcrum'] ?></div>
