	...
	<tbody>
        ...
        ?>
            <tr class="count-product">
		        <td class="product-count"><?php echo $total_items . ' sản phẩm'; ?></td>
		        <td colspan="2">
		            <div class="view-more">
		                <span>Xem chi tiết</span>
		                <img class="arrow-icon" src="<?php echo get_template_directory_uri() . '/images/chevron-down.svg'; ?>" alt="">
		            </div>
		        </td>
		    </tr>
        <?php
        ...
        foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
            ...
            if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key)) {
                ?>
                <tr class="<?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?> content-product">
                	<td class="cout-inproduct">
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        $(".view-more").click(function() {
            $(".content-product").toggle();

            if ($(".content-product").is(":hidden")) {
        ...
        // Hide the content-product initially when the page loads
