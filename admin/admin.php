...
function my_addition_to_login_footer() {
     echo '<div class="reseller-infos">
                                <p>
                                    Hỗ trợ kỹ thuật : <a target="_blank" href="tel:0981488827"><strong> 098 148 8827</strong></a>
                                </p>
                                    Website : <a target="_blank" href="https://www.revica.org/">Revica.org</a>
                                </p>
                                <p>
                                    Email : <a target="_blank" href="mailto:contact@revica.org">contact@revica.org</a> 
                                </p>
                                <p>Địa chỉ: 98 Hoàng Quốc Việt, Cầu Giấy, Hà Nội</p>
                                <p>
